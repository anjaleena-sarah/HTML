...
<body style="background-color:black;">
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center;">
        ...
        WHERE b.status = 'paid'AND p.d_status = 'pending';"; // Assuming you want to fetch bids with a pending status
        ...
        if ($result->num_rows > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<a href='take_order.php?id=$product_id&status=selected'>Take Order</a>";
                echo "</div>";
            }
        } else {
